# Сколько на самом деле стоят ИИ-агенты для кода: 337 цифр, каждая со своей фразой и датой
...
Открытый набор данных. Каждая цифра из 33 полевых заметок — цены, проценты, кратности, количество токенов и длительности — вынесена в отдельную строку, **вместе с полной фразой, откуда она взята, и датой публикации**.
