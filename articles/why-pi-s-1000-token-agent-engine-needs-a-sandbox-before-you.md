...
issue](https://github.com/xyzs996/ai-coding-field-notes/issues/new?template=correction.yml&where=articles%2Fwhy-pi-s-1000-token-agent-engine-needs-a-sandbox-before-you.md&title=%5Bcorrection%5D+Why+Pi%27s+1000-Token+Agent+Engine+Needs+a+Sandbox+Before+You+Touch+It) — the form already knows which write-up you came from;
