...
which unit — [in one line](https://github.com/xyzs996/ai-coding-field-notes/issues/new?template=figure.yml&came_from=articles%2Fai-agent-loop-engineering-karpathy-s-method-for-5x.md). One required field, and the page you came
from is already filled in. **Got a better number?** [Open an
issue](https://github.com/xyzs996/ai-coding-field-notes/issues/new?template=correction.yml&where=articles%2Fai-agent-loop-engineering-karpathy-s-method-for-5x.md&title=%5Bcorrection%5D+AI+Agent+Loop+Engineering%3A+Karpathy%27s+Method+for+5x+Productivity+Gains) — that form knows which write-up you came from too;
