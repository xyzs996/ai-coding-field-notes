...
The 2 figures in this piece — each with the sentence it came from — are in [the figures table](../figures.md), alongside 248 more, as JSON and CSV.

Topics: [Automation Systems](../topics/automation-systems.md) · [SaaS Business](../topics/saas-business.md) · [Cost Savings](../topics/cost-savings.md)
