...
issue](https://github.com/xyzs996/ai-coding-field-notes/issues/new?template=correction.yml&where=articles%2Fchoosing-the-right-ai-model-for-coding-cost-vs-efficiency.md&title=%5Bcorrection%5D+Choosing+the+Right+AI+Model+for+Coding%3A+Cost+vs.+Efficiency) — the form already knows which write-up you came from;
