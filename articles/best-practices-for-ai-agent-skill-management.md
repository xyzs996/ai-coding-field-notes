...
issue](https://github.com/xyzs996/ai-coding-field-notes/issues/new?template=correction.yml&where=articles%2Fbest-practices-for-ai-agent-skill-management.md&title=%5Bcorrection%5D+Best+Practices+for+AI+Agent+Skill+Management) — the form already knows which write-up you came from;
